...
nnoremap <silent> <leader>nS :call MyQuickfixSearch({ 'term': 'scratch_', 'path': my_notes#dir, 'grep': 0 })<cr>

vnoremap <silent> <leader>nn "zy:execute 'edit ' . my_notes#dir . fnameescape(@z)<cr>
