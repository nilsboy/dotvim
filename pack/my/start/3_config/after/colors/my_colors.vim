...
execute  'hi! Operator      guibg='s:none' guifg='s:brown' gui='s:none
...
execute  'hi! Pmenu         guibg='s:greyBright' guifg='s:none' gui='s:none
execute  'hi! PmenuSel      guibg='s:greenLight' guifg='s:none' gui='s:none
execute  'hi! PmenuSbar     guibg='s:greyLight' guifg='s:blue' gui='s:none
execute  'hi! PmenuThumb    guibg='s:grey' guifg='s:none' gui='s:none

execute  'hi! link NormalFloat Pmenu'
