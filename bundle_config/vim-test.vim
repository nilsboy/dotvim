...
function! VimTestStrategyFixedDispatch(cmd)
...
let g:test#custom_strategies = {
    \ 'VimTestStrategyFixedDispatch': function('VimTestStrategyFixedDispatch')
\}
let g:test#strategy = 'VimTestStrategyFixedDispatch'
